...
const Jokers = ({ gameOn, onJokerCall }) =>{
    ...
    return (
        <div className="jokers-wrapper">
            <button ref={friendBtnRef} id="FRIEND" onClick={(e) => handleClick(e)}> <FaPhoneAlt className='unclickable' color='white'/> </button>
            <button ref={fiftyBtnRef} id="FIFTY_FIFTY" onClick={(e) => handleClick(e)}> <BsHexagonHalf className='unclickable' color='white'/> </button>
            <button ref={audienceBtnRef} id="AUDIENCE" onClick={(e) => handleClick(e)}> <BsFillPeopleFill className='unclickable' color='white'/> </button>
        </div>
    )
}
